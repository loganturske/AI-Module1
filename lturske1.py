...
def get_cost_to_move(node, world, costs):
    ...
    costs - a dictonary of the costs associated with symbols of the world map
    """
...
def a_star_search(world, start, goal, costs, moves, heuristic):
    """
    This is the main A* Search algorithm function. It will preform the A* algorithm. Uses a custom Node class found at
    the top of the file
